...
import com.ugd9_b_9978.API.MahasiswaAPI;
import com.ugd9_b_9978.Models.Buku;
import com.ugd9_b_9978.API.BukuAPI;
...
public class TambahEditBuku extends Fragment {
    ...
    private String status, selected, gambar;
    private int idBuku;
    private Buku buku;
    private View view;
            ...
            public void onClick(View v) {
                ...
                if(namaBuku.isEmpty() || pengarang.isEmpty() || txtHarga.getText().toString().isEmpty())
                    ...
                    if(status.equals("tambah"))
                        tambahBuku(namaBuku, pengarang, harga, gambar);
                    else
                        editBuku(idBuku, namaBuku, pengarang, harga, gambar);
                }
            }
        });
    ...
    public void tambahBuku(final String namaBuku, final String pengarang, final Double harga, final String gambar){
        ...
        StringRequest stringRequest = new StringRequest(POST, BukuAPI.URL_ADD, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams()
            {
                ...
                */
                ...
                params.put("harga", Double.toString(harga));
    ...
    public void editBuku(final int idBuku,final String namaBuku, final String pengarang, final Double harga, final String gambar) {
        RequestQueue queue = Volley.newRequestQueue(getContext());
